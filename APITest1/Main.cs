...
@"<Arguments><Add>0</Add></Arguments>");
            ...
            _flow.AddActivity4.A = (decimal)1m;
            ...
            VTDPropertyInfoBase pi1 = new VTDPropertyInfoBase("ExecutionInputParameters","/*[local-name(.)='Arguments'][1]/*[local-name(.)='Add'][1]");
            VTDBaseGetter binding_getter1 = new VTDXPathGetter(pi1,XmlTypeCode.String);
            VTDPropertyInfoBase pi2 = new VTDPropertyInfoBase("B");
            ...
            _flow.AddActivity4.InDirections.Add(bind_dir1);
